...
void*
MM_VirtualMemory::doubleMapArraylet(MM_EnvironmentBase *env, void* arrayletLeaves[], UDATA arrayletLeafCount, UDATA arrayletLeafSize, UDATA byteAmount, struct J9PortVmemIdentifier *newIdentifier, UDATA pageSize, bool isLargePages)
{
	OMRPORT_ACCESS_FROM_OMRVM(_extensions->getOmrVM());
