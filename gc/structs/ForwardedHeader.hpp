...
#define OMR_SELF_FORWARDED_TAG_ ((uintptr_t)OMR_SELF_FORWARDED_TAG)
#else
#define OMR_SELF_FORWARDED_TAG_ 1
#endif
#define OMR_FORWARDED_TAG_MASK (OMR_FORWARDED_TAG | OMR_BEING_COPIED_HINT | OMR_SELF_FORWARDED_TAG_)
