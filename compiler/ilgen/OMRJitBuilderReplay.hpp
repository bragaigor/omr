...
class JitBuilderReplay
    ...
    */
    ...
    virtual const char * const consumeString()          { return NULL; } // DONE
    virtual int8_t consume8bitNumber()                  { return 0; } // DONE
    virtual int16_t consume16bitNumber()                { return 0; } // DONE
    virtual int32_t consume32bitNumber()                { return 0; } // DONE
    virtual int64_t consume64bitNumber()                { return 0; } // DONE
    virtual float consumeFloatNumber()                  { return 0.0F; } // DONE
    virtual double consumeDoubleNumber()                { return 0.0; } // DONE
    virtual TypeID consumeID()                          { return 0; } // DONE
    virtual const char * consumeStatement()             { return NULL; } // DONE
    virtual TR::IlType * consumeType()                  { return static_cast<TR::IlType *>(0); } // DONE
    virtual TR::IlValue * consumeValue()                { return static_cast<TR::IlValue *>(0); } // DONE
    virtual TR::MethodBuilder * consumeMethodBuilder()  { return NULL; }
    virtual TR::IlBuilder * consumeIlBuilder()          { return NULL; }
