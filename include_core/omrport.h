...
#define OMRPORT_VMEM_MEMORY_MODE_FILE_HANDLE 0x000000200
#define OMRPORT_VMEM_MEMORY_MODE_DOUBLE_MAP 0x000000400
...
typedef struct OMRPortLibrary {
	...
	void *(*vmem_get_contiguous_region_memory)(struct OMRPortLibrary *portLibrary, void* addresses[], uintptr_t addressesCount, uintptr_t addressSize, struct J9PortVmemIdentifier *oldIdentifier, struct J9PortVmemIdentifier *newIdentifier, uintptr_t mode, uintptr_t pageSize, OMRMemCategory *category);
...
#define omrvmem_get_contiguous_region_memory(param1, param2, param3, param4, param5, param6, param7, param8) privateOmrPortLibrary->vmem_get_contiguous_region_memory(privateOmrPortLibrary, (param1), (param2), (param3), (param4), (param5), (param6), (param7), (param8))
